...
const DashProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (imageFileUploading) {
      setUpdateUserError(
        "Please wait for image to upload then click on the Update button."
      );
      return;
    }
  ...
  return (
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        />
        <div
          className=" relative w-[125px] h-[125px] self-center cursor-pointer shadow-md overflow-hidden rounded-full"
